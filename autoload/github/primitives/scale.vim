...
let github#primitives#scale#dark = {
  \ 'black': '#010409',
  \ 'white': '#ffffff',
...
" scale#dark_dimmed {{{
" modified from prmitives/data/colors/themes/dark_dimmed.ts
let github#primitives#scale#dark_dimmed = {
  \ 'black': '#1c2128',
  \ 'white': '#cdd9e5',
...
" scale#dark_colorbind {{{
let github#primitives#scale#dark_colorbind  = {
  \ 'black': '#010409',
  \ 'white': '#ffffff',
  \ 'gray': [ '#f0f6fc', '#c9d1d9', '#b1bac4', '#8b949e', '#6e7681', '#484f58', '#30363d', '#21262d', '#161b22', '#0d1117' ],
  \ 'blue': [ '#cae8ff', '#a5d6ff', '#79c0ff', '#58a6ff', '#388bfd', '#1f6feb', '#1158c7', '#0d419d', '#0c2d6b', '#051d4d' ],
...
" scale#dark_high_contrast {{{
let github#primitives#scale#dark_high_contrast = {
  \ 'black': '#010409',
  \ 'white': '#ffffff',
...
" scale#dark_tritanopia {{{
let github#primitives#scale#dark_tritanopia = {
  \ 'black': '#010409',
  \ 'white': '#ffffff',
  \ 'gray': ['#f0f6fc', '#c9d1d9', '#b1bac4', '#8b949e', '#6e7681', '#484f58', '#30363d', '#21262d', '#161b22', '#0d1117'],
  \ 'blue': ['#cae8ff', '#a5d6ff', '#79c0ff', '#58a6ff', '#388bfd', '#1f6feb', '#1158c7', '#0d419d', '#0c2d6b', '#051d4d'],
...
let github#primitives#scale#light = {
  \ 'black': '#1b1f24',
  \ 'white': '#ffffff',
...
" scale#light_colorbind {{{
let github#primitives#scale#light_colorbind = {
  \ 'black': '#1b1f24',
  \ 'white': '#ffffff',
  \ 'gray': ['#f6f8fa', '#eaeef2', '#d0d7de', '#afb8c1', '#8c959f', '#6e7781', '#57606a', '#424a53', '#32383f', '#24292f'],
  \ 'blue': ['#ddf4ff', '#b6e3ff', '#80ccff', '#54aeff', '#218bff', '#0969da', '#0550ae', '#033d8b', '#0a3069', '#002155'],
...
" scale#light_high_contrast {{{
let github#primitives#scale#light_high_contrast = {
  \ 'black': '#010409',
  \ 'white': '#ffffff',
...
" scale#light_tritanopia {{{
let github#primitives#scale#light_tritanopia = {
  \ 'black': '#1b1f24',
  \ 'white': '#ffffff',
  \ 'gray': ['#f6f8fa', '#eaeef2', '#d0d7de', '#afb8c1', '#8c959f', '#6e7781', '#57606a', '#424a53', '#32383f', '#24292f'],
  \ 'blue': ['#ddf4ff', '#b6e3ff', '#80ccff', '#54aeff', '#218bff', '#0969da', '#0550ae', '#033d8b', '#0a3069', '#002155'],
